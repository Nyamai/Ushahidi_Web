...
<p><?php echo tr('core.error_file_line', $file, $line) ?></p>
<?php endif ?>
<p><code class="block"><?php echo $message ?></code></p>
<p class="ushahidi_bugs"><?php echo tr('core.report_bug',"#"); ?>
</p>
<div id="loader"></div>
<?php
...
<?php if ( ! empty($trace)): ?>
<h3><?php echo tr('core.stack_trace') ?></h3>
<?php echo $trace ?>
<?php endif ?>
<p class="stats"><?php echo tr('core.stats_footer', Kohana::config('version.ushahidi_version')) ?></p>
</div>
</body>
</html>