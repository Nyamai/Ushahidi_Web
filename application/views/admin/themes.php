...
?>
			<div class="bg">
				<h2><?php echo $title; ?> 
					...
					<a href="<?php echo url::base() . 'admin/settings/themes' . '" class="active">' . tr('ui_main.themes') . '</a>' ?>
				</h2>
				<?php print form::open(); ?>
				<div class="report-form">
					...
					?>				
					<div class="head">
						<h3><?php echo tr('ui_main.theme_settings');?></h3>
					...
					<div class="sms_holder">
						...
						<div class="theme_holder">
							...
							?></div>
							<strong><?php echo tr('ui_main.theme_default');?></strong><BR />
							<?php echo tr('ui_main.theme_default');?>.<BR />
							<strong><u><?php echo tr('ui_main.version');?></u></strong>: 1.0<BR />
							<strong><u><?php echo tr('ui_main.demo');?></u></strong>: http://www.ushahidi.com<BR />
							<strong><u><?php echo tr('ui_main.contact');?></u></strong>: team@ushahidi.com<BR />
							<strong><u><?php echo tr('ui_main.location');?></u></strong>: 
							<div class="theme_select">
								...
								?> /><?php echo tr('ui_main.select_theme');?>
							</div>												
						</div>
						<!-- / Default Theme -->				
						<?php
						foreach ($themes as $theme)
						{
							...
							<div class="theme_holder">
								...
								<strong><u><?php echo tr('ui_main.version');?></u></strong>: <?php echo $theme['Version'] ?><BR />
								<strong><u><?php echo tr('ui_main.demo');?></u></strong>: <?php echo $theme['Demo'] ?><BR />
								<strong><u><?php echo tr('ui_main.contact');?></u></strong>: <?php echo $theme['Author_Email'] ?><BR />
								<strong><u><?php echo tr('ui_main.location');?></u></strong>: <i>/themes/<?php echo $theme['Template_Dir'] ?>/</i>
								<div class="theme_select">
