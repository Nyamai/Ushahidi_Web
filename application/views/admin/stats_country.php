...
<div class="bg">
	...
	<h3><?php echo tr('stats.country_breakdown');?></h3>
	
	<div id="time-period-selector">
		<p>
			<form method="get" action="<?php print url::base() ?>admin/stats/country/" style="display: inline;">
				<?php echo tr('stats.choose_date_range');?>: <a href="<?php print url::base() ?>admin/stats/country/?range=30"><?php echo tr('stats.time_range_1');?></a> <a href="<?php print url::base() ?>admin/stats/country/?range=90"><?php echo tr('stats.time_range_2');?></a> <a href="<?php print url::base() ?>admin/stats/country/?range=180"><?php echo tr('stats.time_range_3');?></a>  <a href="<?php print url::base() ?>admin/stats/country/"><?php echo tr('stats.time_range_all');?></a>
	...
	<div class="stats-wrapper clearfix">
		<div class="statistic first">
			<h4><?php echo tr('stats.countries');?></h4>
	...
	<div class="two-col tc-left">
		<div class="tabs">
			<!-- tabset -->
			<ul class="tabset">
				<li><a class="active"><?php echo tr('stats.unique_visitors');?></a></li>
			</ul>
			<div class="tab-boxes">
				...
				<div class="tab-box active-tab" id="unique-visitors">
					<table class="table-graph generic-data">
						<tr>
							<th class="gdItem"><?php echo tr('stats.country');?></th>
							<th class="gdDesc"><?php echo tr('stats.unique_visitors');?></th>
						</tr>
						<?php
