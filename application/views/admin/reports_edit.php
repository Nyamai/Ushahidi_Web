...
?>
			<div class="bg">
				<h2><?php print $title; ?> <span></span><a href="<?php print url::base() ?>admin/reports"><?php echo tr('ui_main.view_reports');?></a><a href="<?php print url::base() ?>admin/reports/download"><?php echo tr('ui_main.download_reports');?></a><a href="<?php print url::base() ?>admin/reports/upload"><?php echo tr('ui_main.upload_reports');?></a></h2>
				<?php print form::open(NULL, array('enctype' => 'multipart/form-data', 'id' => 'reportForm', 'name' => 'reportForm')); ?>
					...
					<div class="report-form">
						...
						?>
							<!-- green-box -->
							<div class="green-box">
								<h3><?php echo tr('ui_main.report_saved');?></h3>
							</div>
						<?php
						}
						?>
						<div class="head">
							<h3><?php echo $id ? tr('ui_main.edit_report') : tr('ui_main.new_report'); ?></h3>
							<div class="btns" style="float:right;">
								<ul>
									<li><a href="#" class="btn_save"><?php echo strtoupper(tr('ui_main.save_report'));?></a></li>
									<li><a href="#" class="btn_save_close"><?php echo strtoupper(tr('ui_main.save_close'));?></a></li>
									<li><a href="<?php echo url::base().'admin/reports/';?>" class="btns_red"><?php echo strtoupper(tr('ui_main.cancel'));?></a>&nbsp;&nbsp;&nbsp;</li>
									<?php if ($id) {?>
									<li><a href="<?php echo $previous_url;?>" class="btns_gray">&laquo; <?php echo strtoupper(tr('ui_main.previous'));?></a></li>
									<li><a href="<?php echo $next_url;?>" class="btns_gray"><?php echo strtoupper(tr('ui_main.next'));?> &raquo;</a></li>
									<?php } ?>
								</ul>
							</div>
						</div>
						...
						<div class="f-col">
							...
							<div class="row">
								<h4 style="margin:0;padding:0;"><a href="#" id="messages_toggle" class="show-messages"><?php echo tr('ui_main.show_messages');?></a>&nbsp;</h4>
							...
							<?php } ?>
							<div class="row">
								<h4><?php echo tr('ui_main.form');?> <span>(<?php echo tr('ui_main.select_form_type');?>)</span></h4>
							...
							<div class="row">
								<h4><?php echo tr('ui_main.title');?></h4>
								<?php print form::input('incident_title', $form['incident_title'], ' class="text title"'); ?>
							</div>
							<div class="row">
								<h4><?php echo tr('ui_main.description');?> <span><?php echo tr('ui_main.include_detail');?>.</span></h4>
							...
							{ // Use default date for new report
								...
								<div class="row" id="datetime_default">
									<h4><a href="#" id="date_toggle" class="new-cat"><?php echo tr('ui_main.modify_date');?></a><?php echo tr('ui_main.modify_date');?>: 
									<?php echo tr('ui_main.today_at').' '.$form['incident_hour']
							...
							<div class="row <?php
								...
								<div class="date-box">
									<h4><?php echo tr('ui_main.date');?> <span><?php echo tr('ui_main.date_format');?></span></h4>
									<?php print form::input('incident_date', $form['incident_date'], ' class="text"'); ?>								
									<?php print $date_picker_js; ?>				    
								</div>
								<div class="time">
									<h4><?php echo tr('ui_main.time');?> <span>(<?php echo tr('ui_main.approximate');?>)</span></h4>
									<?php
							...
							<div class="row">
								<h4><a href="#" id="category_toggle" class="new-cat"><?php echo tr('ui_main.new_category');?></a><?php echo tr('ui_main.categories');?> 
								<span><?php echo tr('ui_main.select_multiple');?>.</span></h4>
								<?php print $new_category_toggle_js; ?>
								<!--category_add form goes here-->
			                    <div id="category_add" class="category_add">
			                        <?php
			                        print '<p>'.tr('ui_main.add_new_category').'<hr/></p>';
                                    print form::label(array("id"=>"category_name_label", "for"=>"category_name"), tr('ui_main.name'));
                                    print '<br/>';
                                    print form::input('category_name', $new_categories_form['category_name'], 'class=""');
                                    print '<br/>';
                                    print form::label(array("id"=>"description_label", "for"=>"description"), tr('ui_main.description'));
                                    print '<br/>';
                                    print form::input('category_description', $new_categories_form['category_description'], 'class=""');
                                    print '<br/>';
                                    print form::label(array("id"=>"color_label", "for"=>"color"), tr('ui_main.color'));
                                    print '<br/>';
                                    print form::input('category_color', $new_categories_form['category_color'], 'class=""');
                                    print $color_picker_js;
                                    print '<br/>';
                                    print '<span>';
                                    print '<a href="#" id="add_new_category">'.tr('ui_main.add').'</a>';
                                    print '</span>';
                                    ?> 
                                </div>
						...
						<div class="f-col-1">
							<div class="incident-location">
								<h4><?php echo tr('ui_main.incident_location');?></h4>
							...
							<div class="incident-find-location">
								<?php print form::input('location_find', '', ' title="'.tr('ui_main.location_example').'" class="findtext"'); ?>
								<div class="btns" style="float:left;">
									<ul>
										<li><a href="#" class="btn_find"><?php echo strtoupper(tr('ui_main.find_location'));?></a></li>
									</ul>
								</div>
								<div id="find_loading" class="incident-find-loading"></div>
								<div style="clear:both;"><?php echo tr('ui_main.pinpoint_location');?>.</div>
							</div>
							<div class="row">
								<div class="town">
									<h4><?php echo tr('ui_main.reports_location_name');?> <br /><span><?php echo tr('ui_main.detailed_location_example');?></span></h4>
							...
							<div class="row link-row">
								<h4><?php echo tr('ui_main.reports_news');?></h4>
							</div>
							<div id="divNews">
								<?php
								$this_div = "divNews";
							...
							<!-- Video Fields -->
							<div class="row link-row">
								<h4><?php echo tr('ui_main.reports_video');?></h4>
							</div>
							<div id="divVideo">
								<?php
								$this_div = "divVideo";
							...
							<!-- Photo Fields -->
							<div class="row link-row">
								<h4><?php echo tr('ui_main.reports_photos');?></h4>
								<?php								
    								if ($incident != "0")
                        			{
                        				// Retrieve Media
                        				foreach($incident->media as $photo) 
                        				{
                        					if ($photo->media_type == 1)
                        					{
                        						...
                        						print "&nbsp;&nbsp;<a href=\"#\" onClick=\"deletePhoto('". $photo->id ."', 'photo_". $photo->id ."'); return false;\" >".tr('ui_main.delete')."</a>";
                        						print "</div>";
                        					}
                        				}
                        			}
						...
						<div class="f-col-bottom-container">
							<div class="f-col-bottom">
								<div class="row">
									<h4><?php echo tr('ui_main.personal_information');?></span></h4>
									<label>
										<span><?php echo tr('ui_main.first_name');?></span>
										<?php print form::input('person_first', $form['person_first'], ' class="text"'); ?>
									</label>
									<label>
										<span><?php echo tr('ui_main.last_name');?></span>
										<?php print form::input('person_last', $form['person_last'], ' class="text"'); ?>
									</label>
								</div>
								<div class="row">
									<label>
										<span><?php echo tr('ui_main.email_address');?></span>
							...
							<div class="f-col-bottom-1">
								<h4><?php echo tr('ui_main.information_evaluation');?></h4>
								<div class="row">
									<div class="f-col-bottom-1-col"><?php echo tr('ui_main.approve_this_report');?>?</div>
								...
								<div class="row">
									<div class="f-col-bottom-1-col"><?php echo tr('ui_main.verify_this_report');?>?</div>
								...
								<div class="row">
									<div class="f-col-bottom-1-col"><?php echo tr('ui_main.report_edit_dropdown_1_title');?>:</div>
									<?php print form::dropdown('incident_source', 
									array(""=> tr('ui_main.report_edit_dropdown_1_default'), 
									"1"=> tr('ui_main.report_edit_dropdown_1_item_1'), 
									"2"=> tr('ui_main.report_edit_dropdown_1_item_2'), 
									"3"=> tr('ui_main.report_edit_dropdown_1_item_3'), 
									"4"=> tr('ui_main.report_edit_dropdown_1_item_4'), 
									"5"=> tr('ui_main.report_edit_dropdown_1_item_5'), 
									"6"=> tr('ui_main.report_edit_dropdown_1_item_6')
									)
									, $form['incident_source']) ?>									
								</div>
								<div class="row">
									<div class="f-col-bottom-1-col"><?php echo tr('ui_main.report_edit_dropdown_2_title');?>:</div>
									<?php print form::dropdown('incident_information', 
									array(""=> tr('ui_main.report_edit_dropdown_1_default'), 
									"1"=> tr('ui_main.report_edit_dropdown_2_item_1'), 
									"2"=> tr('ui_main.report_edit_dropdown_2_item_2'), 
									"3"=> tr('ui_main.report_edit_dropdown_2_item_3'), 
									"4"=> tr('ui_main.report_edit_dropdown_2_item_4'), 
									"5"=> tr('ui_main.report_edit_dropdown_2_item_5'), 
									"6"=> tr('ui_main.report_edit_dropdown_2_item_6')
									)
						...
						<div class="btns">
							<ul>
								...
								if($id)
								{
									echo "<li><a href=\"#\" class=\"btn_delete btns_red\">".strtoupper(tr('ui_main.delete_report'))."</a></li>";
								}
								?>
								<li><a href="<?php echo url::base().'admin/reports/';?>" class="btns_red"><?php echo strtoupper(tr('ui_main.cancel'));?></a></li>
							</ul>
