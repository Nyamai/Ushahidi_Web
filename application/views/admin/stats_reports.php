...
<div class="bg">
    ...
    <div class="content-wrap clearfix">
        <h3><?php echo tr('stats.reports_statistics');?></h3>
        
        <div id="time-period-selector">
			<p>
				<form method="get" action="<?php print url::base() ?>admin/stats/reports/" style="display: inline;">
					<?php echo tr('stats.choose_date_range');?>: <a href="<?php print url::base() ?>admin/stats/reports/?range=30"><?php echo tr('stats.time_range_1');?></a> <a href="<?php print url::base() ?>admin/stats/reports/?range=90"><?php echo tr('stats.time_range_2');?></a> <a href="<?php print url::base() ?>admin/stats/reports/?range=180"><?php echo tr('stats.time_range_3');?></a> <a href="<?php print url::base() ?>admin/stats/reports/"><?php echo tr('stats.time_range_all');?></a>
        ...
        <div class="two-col tc-left reports-charts">
            ...
            <h4><?php echo tr('stats.reports_categories');?></h4>
            <p>
            ...
            <h4><?php echo tr('stats.reports_status');?></h4>
            <p>
				...
				<div style="float:left;">
					<table>
						<tr>
							<td><div id="little-color-box" style="background-color:#0E7800">&nbsp;</div></td>
							<td><?php echo tr('stats.approved');?></td>
							<td style="padding-left:25px;"><?php echo $approved; ?></td>
						</tr>
						<tr>
							<td><div id="little-color-box" style="background-color:#FFCF00">&nbsp;</div></td>
							<td><?php echo tr('stats.unapproved');?></td>
