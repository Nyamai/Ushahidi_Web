...
?>
			<div class="bg">
				<h2><?php print $title; ?> <span></span><a href="<?php print url::base() ?>admin/reports"><?php echo tr('ui_main.view_reports');?></a></h2>
				<?php print form::open(NULL, array('id' => 'reportForm', 'name' => 'reportForm')); ?>
					...
					<div class="report-form">
						...
						?>
							<!-- green-box -->
							<div class="green-box">
								<h3><?php echo tr('ui_main.translation_saved');?></h3>
							</div>
						<?php
						}
						?>
						...
						<div class="f-col-full">
							<div class="row">
								<div class="translation">
									<h4><?php echo tr('ui_main.translate_to');?>?</h4>
