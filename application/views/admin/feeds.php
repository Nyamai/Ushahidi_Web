...
?>
			<div class="bg">
				...
				<div class="tabs">
					<!-- tabset -->
					<ul class="tabset">
						<li><a href="<?php echo url::base() . 'admin/manage/feeds' ?>" class="active"><?php echo tr('ui_main.feeds');?></a></li>
						<li><a href="<?php echo url::base() . 'admin/manage/feeds_items' ?>"><?php echo tr('ui_main.feed_items');?></a></li>
					</ul>
					
					<!-- tab -->
					<div class="tab">
						<ul>
							<li><a href="javascript:refreshFeeds();"><?php echo strtoupper(tr('ui_main.refresh_news_feeds'));?></a></li><span id="feeds_loading"></span>
						</ul>
					</div>
				</div>
				<?php
				...
				?>
					<!-- green-box -->
					<div class="green-box">
						<h3><?php echo tr('ui_main.feed_has_been');?> <?php echo $form_action; ?>!</h3>
					</div>
				<?php
				}
				?>
						...
						<div class="table-holder">
							<table class="table">
								<thead>
									<tr>
										<th class="col-1">&nbsp;</th>
										<th class="col-2"><?php echo tr('ui_main.feed');?></th>
										<th class="col-3"><?php echo tr('ui_main.items');?></th>
								...
								<tbody>
									...
									foreach ($feeds as $feed)
									{
										...
										<tr>
											...
											<td class="col-2">
												<div class="post">
													<h4><?php echo $feed_name; ?>&nbsp;&nbsp;&nbsp;[<a href="<?php echo url::base() . 'admin/manage/feeds_items/'.$feed_id ?>"><?php echo tr('ui_main.view_items');?></a>]</h4>
											...
											<td class="col-4">
												<ul>
													<li class="none-separator"><a href="#add" onClick="fillFields('<?php echo(rawurlencode($feed_id)); ?>','<?php echo(rawurlencode($feed_name)); ?>','<?php echo(rawurlencode($feed_url)); ?>')"><?php echo tr('ui_main.edit');?></a></li>
													<li class="none-separator"><a href="javascript:feedAction('v','SHOW/HIDE','<?php echo(rawurlencode($feed_id)); ?>')"<?php if ($feed_active) echo " class=\"status_yes\"" ?>><?php echo tr('ui_main.visible');?></a></li>
													<li><a href="javascript:feedAction('d','DELETE','<?php echo(rawurlencode($feed_id)); ?>')" class="del"><?php echo tr('ui_main.delete');?></a></li>
												</ul>
											</td>
										</tr>
										<?php
				...
				<div class="tabs">
					...
					<div class="tab">
						...
						<div class="tab_form_item">
							<strong><?php echo tr('ui_main.feed_name');?>:</strong><br />
							<?php print form::input('feed_name', '', 
							' class="text"'); ?>
						</div>
						<div class="tab_form_item">
							<strong><?php echo tr('ui_main.feed_url');?>:</strong><br />
