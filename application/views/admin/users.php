...
?>
			<div class="bg">
				<h2><?php echo tr('ui_admin.title')?></h2>
				<!-- tabs -->
				<div class="tabs">
					...
					<ul class="tabset">
						<li>
							<a href="#" class="active">
								<?php echo tr('ui_admin.header_add_edit'); ?>
							</a>
						</li>
					</ul>
					<!-- tab -->
					<div class="tab">
						...
						<div class="tab_form_item">
							<strong><?php echo tr('ui_admin.label_username');?></strong><br />
							<?php print form::input('username', $form['username'], 
								' class="text"'); ?>
						</div>
						<div class="tab_form_item">
							<strong><?php echo tr('ui_admin.label_password');?></strong><br />
							<?php print form::password('password', $form['password'], 
								' class="text"'); ?>
						</div>
						
						<div class="tab_form_item">
							<strong><?php echo tr('ui_admin.label_full_name');?></strong><br />
							<?php print form::input('name', $form['name'], ' class="text"'); ?>
						</div>
						<div class="tab_form_item">
							<strong><?php echo tr('ui_admin.label_email');?></strong><br />
							<?php print form::input('email', $form['email'], ' class="text"'); ?>
						</div>
						<div class="tab_form_item">
							<strong><?php echo tr('ui_admin.label_role');?></strong><br />
				...
				<div class="report-form">
					...
					?>
						<!-- red-box -->
						<div class="red-box">
							<h3><?php echo tr('ui_admin.error_msg');?></h3>
							<ul>
							<?php
					...
					?>
						...
						<div class="green-box">
							<h3>
								<?php echo tr('ui_admin.confirm_msg'); ?> 
						...
						<div class="table-holder">
							<table class="table">
								<thead>
									<tr>
										<th class="col-1">
											<?php echo tr('ui_admin.header_user'); ?>
										</th>
										<th class="col-2">
											<?php echo tr('ui_admin.header_email'); ?>
										</th>
										<th class="col-2">
											<?php echo tr('ui_admin.header_role');?>
										</th>
										<th class="col-4">
											<?php echo tr('ui_admin.header_actions')?>
										</th>
									</tr>
								</thead>
								<tfoot>
									...
									?>
										<tr>
											<td colspan="4" class="col">
												<h3>
													<?php echo tr('ui_admin.no_result_display_msg');?>
												</h3>
											</td>
										</tr>
									<?php	
									...
									foreach ($users as $user)
									{
										...
										<tr>
											...
											<td class="col-3">
												<?php  
													if( $role == "admin") 
														echo tr('ui_admin.admin_role');
													else if ($role == "login")
														echo tr('ui_admin.login_role');
													else 
														echo tr('ui_admin.superadmin_role');
												?>
											</td>
											<td class="col-4">
												<ul>
