...
?>
			<div class="bg">
				<h2>
					...
					<a href="<?php echo url::base() . 'admin/manage/organizations' ?>" class="active"><?php echo tr('ui_main.organizations');?></a>
				...
				?>
					<!-- green-box -->
					<div class="green-box">
						<h3><?php echo tr('ui_main.organization_has_been');?> <?php echo $form_action; ?></h3>
					</div>
				<?php
				}
				?>
	...
	'<?php echo(rawurlencode($organization_phone2)); ?>')"><?php echo tr('ui_main.edit');?></a></li>
	<li class="none-separator"><a href="javascript:orgAction('v','SHOW/HIDE','<?php echo(rawurlencode($organization_id)); ?>')"<?php if ($organization_active) echo " class=\"status_yes\"" ?>><?php echo tr('ui_main.visible');?></a></li>
													<li><a href="javascript:orgAction('d','DELETE','<?php echo(rawurlencode($organization_id)); ?>')" class="del"><?php echo tr('ui_main.delete');?></a></li>
												</ul>
											</td>
										</tr>
										<?php
