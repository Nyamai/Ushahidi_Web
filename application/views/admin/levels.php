			<div class="bg">
				<h2>
					...
					<a href="<?php echo url::base() . 'admin/manage/levels' ?>" class="active"><?php echo tr('ui_main.reporter_levels');?></a>
				...
				?>
					<!-- green-box -->
					<div class="green-box">
						<h3><?php echo tr('ui_main.level_has_been');?> <?php echo $form_action; ?>!</h3>
					</div>
				<?php
				}
				?>
						...
						<div class="table-holder">
							<table class="table">
								<thead>
									<tr>
										<th class="col-1">&nbsp;</th>
										<th class="col-2"><?php echo tr('ui_main.level');?></th>
										<th class="col-3"><?php echo tr('ui_main.weight');?></th>
								...
								<tbody>
									...
									foreach ($levels as $level)
									{
										...
										<tr>
											...
											<td class="col-4">
												<ul>
													<li class="none-separator"><a href="#add" onClick="fillFields('<?php echo(rawurlencode($level_id)); ?>','<?php echo(rawurlencode($level_title)); ?>','<?php echo(rawurlencode($level_description)); ?>','<?php echo(rawurlencode($level_weight)); ?>')"><?php echo tr('ui_main.edit');?></a></li>
<li><a href="javascript:catAction('d','DELETE','<?php echo(rawurlencode($level_id)); ?>')" class="del"><?php echo tr('ui_main.delete');?></a></li>
												</ul>
											</td>
										</tr>
										<?php
				...
				<div class="tabs">
					...
					<ul class="tabset">
						...
						<li><a href="#"><?php echo tr('ui_main.add_language');?></a></li>
					</ul>
					<!-- tab -->
					<div class="tab">
						...
						<div class="tab_form_item">
							<strong><?php echo tr('ui_main.level_name');?>:</strong><br />
						...
						<div class="tab_form_item">
							<strong><?php echo tr('ui_main.weight');?>:</strong><br />
