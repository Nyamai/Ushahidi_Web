			...
			<div class="bg">
				...
				<div class="report-form">
					...
					<div class="sms_nav_holder">
						<a href="<?php echo url::base() . 'admin/settings/sms' ?>"><?php echo tr('settings.sms.option_1');?></a>
						<a href="<?php echo url::base() . 'admin/settings/smsglobal' ?>" class="active"><?php echo tr('settings.sms.option_2');?></a>
					</div>
					...
					<div class="sms_holder">
						<table style="width: 630px;" class="my_table">
							<tr>
								...
								<td>
									<h4 class="fix"><?php echo tr('settings.sms.clickatell_text_1');?>. <sup><a href="#">?</a></sup></h4>
								</td>
							</tr>
							<tr>
								<td>
								...
								<td>
									<h4 class="fix"><?php echo tr('settings.sms.clickatell_text_2');?>. <sup><a href="#">?</a></sup></h4>
									<div class="row">
										<h4><?php echo tr('settings.sms.clickatell_api');?>:</h4>
										<?php print form::input('clickatell_api', $form['clickatell_api'], ' class="text title_2"'); ?>
									</div>
									<div class="row">
										<h4><?php echo tr('settings.sms.clickatell_username');?>:</h4>
										<?php print form::input('clickatell_username', $form['clickatell_username'], ' class="text title_2"'); ?>
									</div>
									<div class="row">
										<h4><?php echo tr('settings.sms.clickatell_password');?>:</h4>
							...
							<!--<tr>
								...
								<td>
									<h4 class="fix"><?php echo tr('settings.sms.clickatell_check_balance');?>. <sup><a href="#">?</a></sup></h4>
									<div class="row">
										<h4><a href="javascript:clickatellBalance()"><?php echo tr('settings.sms.clickatell_load_balance');?></a>&nbsp;<span id="balance_loading"></span></h4>
									</div>
								</td>
							</tr>-->							
						</table>
