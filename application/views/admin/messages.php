...
?>
			<div class="bg">
				...
				<div class="tabs">
					<!-- tabset -->
					<ul class="tabset">
						<li><a href="?type=1" <?php if ($type == '1') echo "class=\"active\""; ?>><?php echo tr('ui_main.inbox');?></a></li>
						<?php
						if ($service_id == 1)
						{
							?><li><a href="?type=2" <?php if ($type == '2') echo "class=\"active\""; ?>><?php echo tr('ui_main.outbox');?></a></li><?php
						}
						?>
						<li><a href="?type=<?php echo $type ?>&period=a" <?php if ($period == 'a') echo "class=\"active\""; ?>><?php echo tr('ui_main.all');?></a></li>
						<li><a href="?type=<?php echo $type ?>&period=d" <?php if ($period == 'd') echo "class=\"active\""; ?>><?php echo tr('ui_main.yesterday');?></a></li>
						<li><a href="?type=<?php echo $type ?>&period=m" <?php if ($period == 'm') echo "class=\"active\""; ?>><?php echo tr('ui_main.last_month');?></a></li>
						<li><a href="?type=<?php echo $type ?>&period=y" <?php if ($period == 'y') echo "class=\"active\""; ?>><?php echo tr('ui_main.last_year');?></a></li>
					</ul>
					<!-- tab -->
					<div class="tab">
						<ul>
							<li><a href="#" onClick="submitIds()"><?php echo strtoupper(tr('ui_main.delete'));?></a></li>
				...
				?>
					...
					<div class="green-box" id="submitStatus">
						<h3><?php echo tr('ui_main.messages');?> <?php echo $form_action; ?> <a href="#" id="hideMessage" class="hide">hide this message</a></h3>
					</div>
				<?php
				}
				?>
						...
						<table class="table">
							<thead>
								<tr>
									...
									<th class="col-2"><?php echo tr('ui_main.message_details');?></th>
									...
									<tr>
										...
										<td class="col-2">
											<div class="post">
												...
												{
													?>
													<p><a href="javascript:preview('message_preview_<?php echo $message_id?>')"><?php echo tr('ui_main.preview_message');?></a></p>
												...
												if ($service_id == 1 && $message_type == 1)
												{
													...
													<a href="javascript:showReply('reply_<?php echo $message_id; ?>')" class="more">+<?php echo tr('ui_main.reply');?></a>
													<div id="reply_<?php echo $message_id; ?>" class="reply">
														...
														<div class="reply_can"><a href="javascript:cannedReply('1', 'message_<?php echo $message_id; ?>')">+<?php echo tr('ui_main.request_location');?></a>&nbsp;&nbsp;&nbsp;<a href="javascript:cannedReply('2', 'message_<?php echo $message_id; ?>')">+<?php echo tr('ui_main.request_information');?></a></div>
										...
										<td class="col-4">
											<ul>
												...
												?>
												<li>
                                                <a href="<?php echo url::base().'admin/messages/delete/'.$message_id ?>" onclick="return confirm('Delete cannot be undone. Are you sure you want to continue?')" class="del"><?php echo tr('ui_main.delete');?></a></li>
											</ul>
										</td>
									</tr>
									<?php
