...
?>
			<div class="bg">
				<h2>
					<a href="<?php echo url::base() . 'admin/manage' ?>" class="active"><?php echo tr('ui_main.categories');?></a>
				...
				?>
					<!-- green-box -->
					<div class="green-box">
						<h3><?php echo tr('ui_main.category_has_been');?> <?php echo $form_action; ?>!</h3>
					</div>
				<?php
				}
				?>
						...
						<div class="table-holder">
							<table class="table">
								<thead>
									<tr>
										<th class="col-1">&nbsp;</th>
										<th class="col-2"><?php echo tr('ui_main.category');?></th>
									...
									foreach ($categories as $category)
									{
										...
										<tr>
											...
											<?php if (!empty($category_image))
											{
												...
												echo "&nbsp;[<a href=\"javascript:catAction('i','DELETE ICON','".rawurlencode($category_id)."')\"><?php echo tr('ui_main.delete');?></a>]";
											}
											else
											{
											...
											<td class="col-4">
												<ul>
													<li class="none-separator"><a href="#add" onClick="fillFields('<?php echo(rawurlencode($category_id)); ?>','<?php echo(rawurlencode($parent_id)); ?>','<?php echo(rawurlencode($category_title)); ?>','<?php echo(rawurlencode($category_description)); ?>','<?php echo(rawurlencode($category_color)); ?>','<?php echo(rawurlencode($category_image)); ?>')"><?php echo tr('ui_main.edit');?></a></li>
													<li class="none-separator"><a href="javascript:catAction('v','SHOW/HIDE','<?php echo(rawurlencode($category_id)); ?>')"<?php if ($category_visible) echo " class=\"status_yes\"" ?>><?php echo tr('ui_main.visible');?></a></li>
<li><a href="javascript:catAction('d','DELETE','<?php echo(rawurlencode($category_id)); ?>')" class="del"><?php echo tr('ui_main.delete');?></a></li>
												</ul>
											</td>
										</tr>
										<?php
				...
				<div class="tabs">
					...
					<div class="tab">
						...
						<div class="tab_form_item">
							<strong><?php echo tr('ui_main.category_name');?>:</strong><br />
							<?php print form::input('category_title', '', ' class="text"'); ?>
						</div>
						<div class="tab_form_item">
							<strong><?php echo tr('ui_main.description');?>:</strong><br />
						...
						<div class="tab_form_item">
							<strong><?php echo tr('ui_main.parent_category');?>:</strong><br />
							<?php print form::dropdown('parent_id', $parents_array, '0'); ?>
						</div>
						<div style="clear:both"></div>
						<div class="tab_form_item">
							<strong><?php echo tr('ui_main.image_icon');?>:</strong><br />
							<?php
