...
?>
			<div class="bg">
				<h2><?php echo $title; ?> 
					<a href="<?php echo url::base() . 'admin/settings/site' . '" class="active">' . tr('ui_main.site') . '</a>' ?>
				...
				<div class="report-form">
					...
					?>				
					<div class="head">
						<h3><?php echo tr('settings.site.title');?></h3>
					...
					<div class="sms_holder">
						<div class="row">
							<h4><a href="#" class="tooltip" title="<?php echo tr("tooltips.settings_site_name"); ?>"><?php echo tr('settings.site.name');?></a></h4>
							<?php print form::input('site_name', $form['site_name'], ' class="text long2"'); ?>
						</div>
						<div class="row">
							<h4><a href="#" class="tooltip" title="<?php echo tr("tooltips.settings_site_tagline"); ?>"><?php echo tr('settings.site.tagline');?></a></h4>
							<?php print form::input('site_tagline', $form['site_tagline'], ' class="text long2"'); ?>
						</div>
						<div class="row">
							<h4><a href="#" class="tooltip" title="<?php echo tr("tooltips.settings_site_email"); ?>"><?php echo tr('settings.site.email_site');?></a> 
							<br /><?php echo tr('settings.site.email_notice');?></h4>
							<?php print form::input('site_email', $form['site_email'], ' class="text long2"'); ?>
						</div>
						<div class="row">
							<h4><a href="#" class="tooltip" title="<?php echo tr("tooltips.settings_alert_email"); ?>"><?php echo tr('settings.site.email_alerts');?></a></h4>
							<?php print form::input('alerts_email', $form['alerts_email'], ' class="text long2"'); ?>
						</div>
						<div class="row">
							<h4><a href="#" class="tooltip" title="<?php echo tr("tooltips.settings_locale"); ?>"><?php echo tr('settings.site.language');?></a> (Locale)</h4>
							<span class="sel-holder">
								<?php print form::dropdown('site_language', $locales_array, $form['site_language']); ?>
							</span>
						</div>
						<div class="row">
							<h4><?php echo tr('settings.site.display_contact_page');?>?</h4>
							<?php print form::dropdown('site_contact_page', $yesno_array, $form['site_contact_page']); ?>
						</div>
						<div class="row">
							<h4><?php echo tr('settings.site.display_howtohelp_page');?>?</h4>
							<?php print form::dropdown('site_help_page', $yesno_array, $form['site_help_page']); ?>
						</div>
						<div class="row">
							<h4><?php echo tr('settings.site.items_per_page');?></h4>
							<span class="sel-holder">
								<?php print form::dropdown('items_per_page', $items_per_page_array, $form['items_per_page']); ?>
							</span>
						</div>
						<div class="row">
							<h4><?php echo tr('settings.site.items_per_page_admin');?></h4>
							<span class="sel-holder">
								<?php print form::dropdown('items_per_page_admin', $items_per_page_array, $form['items_per_page_admin']); ?>
							</span>
						</div>
						<div class="row">
							<h4><?php echo tr('settings.site.allow_reports');?>?</h4>
							<span class="sel-holder">
								<?php print form::dropdown('allow_reports', $yesno_array, $form['allow_reports']); ?>
							</span>
						</div>
						<div class="row">
							<h4><?php echo tr('settings.site.allow_comments');?>?</h4>
							<span class="sel-holder">
								<?php print form::dropdown('allow_comments', $yesno_array, $form['allow_comments']); ?>
							</span>
						</div>
						<div class="row">
							<h4><?php echo tr('settings.site.allow_feed');?>?</h4>
							<span class="sel-holder">
								<?php print form::dropdown('allow_feed', $yesno_array, $form['allow_feed']); ?>
							</span>
						</div>
						<div class="row">
							<h4><?php echo tr('settings.site.share_site_stats');?>?</h4>
							<span class="sel-holder">
								<?php print form::dropdown('allow_stat_sharing', $yesno_array, $form['allow_stat_sharing']); ?>
							</span>
						</div>
						<div class="row">
							<h4><?php echo tr('settings.site.allow_clustering');?>?</h4>
							<span class="sel-holder">
								<?php print form::dropdown('allow_clustering', $yesno_array, $form['allow_clustering']); ?>
							</span>
						</div>
						<div class="row">
							<h4><?php echo tr('settings.site.default_category_colors');?></h4>
						...
						<div class="row">
							<h4><?php echo tr('settings.site.google_analytics');?></h4>
							<?php echo tr('settings.site.google_analytics_example');?> &nbsp;&nbsp;
							<?php print form::input('google_analytics', $form['google_analytics'], ' class="text"'); ?>
						</div>
						<div class="row">
							<h4><?php echo tr('settings.site.twitter_configuration');?></h4>
							<div class="row">
								<?php echo tr('settings.site.twitter_hashtags');?>
								<?php print form::input('twitter_hashtags', $form['twitter_hashtags'], ' class="text"'); ?>
							</div>
							<div class="row" style="padding-top:5px;">
								<?php echo tr('ui_main.username');?>
								<?php print form::input('twitter_username', $form['twitter_username'], ' class="text"'); ?>
							</div>
							<div class="row" style="padding-top:5px;">
								<?php echo tr('ui_main.password');?>
								<?php print form::password('twitter_password', $form['twitter_password'], ' class="text"'); ?>
							</div>
						</div>
						<div class="row">
							<h4><?php echo tr('settings.site.laconica_configuration');?></h4>
							...
							<div class="row">
								...
								<div class="row" style="padding-top:5px;">
								<?php echo tr('settings.site.laconica_site');?>
								<?php print form::input('laconica_site', $form['laconica_site'], 'class="text long2"'); ?>
							</div>
						</div>
						<div class="row">
							<h4><?php echo tr('settings.site.api_akismet');?></h4>
							<?php echo tr('settings.site.kismet_notice');?>.
