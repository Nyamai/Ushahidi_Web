...
?>	
		<div class="bg">
			<h2>
				...
				<a href="<?php echo url::base() . 'admin/manage/forms' ?>" class="active"><?php echo tr('ui_main.forms');?></a>
			...
			?>
				<!-- green-box -->
				<div class="green-box">
					<h3><?php echo tr('ui_main.form_has_been');?> <?php echo $form_action; ?>!</h3>
				</div>
			<?php
			}
			?>
				...
				<div class="table-holder">
					<table class="table">
						<thead>
							<tr>
								<th class="col-1">&nbsp;</th>
								<th class="col-2"><?php echo tr('ui_main.form');?></th>
								<th class="col-3">&nbsp;</th>
							...
							foreach ($forms as $form)
							{
								...
								<?php print form::open(NULL,array('id' => 'form_action_' . $form_id,
									...
									<tr id="tr_<?php echo $form_id; ?>">
										...
										<td class="col-2">
											<div class="post">
												<h4><?php echo $form_title; ?>&nbsp;&nbsp;&nbsp;[<a href="javascript:showForm('formDiv_<?php echo $form_id; ?>')"><?php echo tr('ui_main.edit_form_fields');?></a></li>]</h4>
										...
										<td class="col-4">
											<ul>
												...
												<li class="none-separator"><a href="javascript:formAction('a','SHOW/HIDE','<?php echo(rawurlencode($form_id)); ?>')"<?php if ($form_active) echo " class=\"status_yes\"" ?>><?php echo tr('ui_main.active');?></a></li>
												<li><a href="javascript:formAction('d','DELETE','<?php echo(rawurlencode($form_id)); ?>')" class="del"><?php echo tr('ui_main.delete');?></a></li>
											</ul>
										</td>
									</tr>
												...
												<div class="tab">
													<div>
														<?php echo form::open(url::base() . 'admin/manage/forms/field_add', array('id' => 'form_field_'.$form_id,
															...
															<strong><?php echo tr('ui_main.select_field_type');?>:</strong>
			...
			<div class="tabs">
				...
				<a name="add"></a>
				<ul class="tabset">
					<li><a href="#" class="active"><?php echo tr('ui_main.create_edit');?> <?php echo tr('ui_main.form');?></a></li>
				</ul>
				<!-- tab -->
				<div class="tab">
					...
					<div class="tab_form_item">
						<strong><?php echo tr('ui_main.form_title');?>:</strong><br />
						<?php print form::input('form_title', '', 
						' class="text"'); ?>
					</div>
					<div class="tab_form_item">
						<strong><?php echo tr('ui_main.form_description');?>:</strong><br />
