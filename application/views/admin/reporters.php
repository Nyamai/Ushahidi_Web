		<div class="bg">
				<h2>
					...
					<a href="<?php echo url::base() . 'admin/manage/reporters' ?>" class="active"><?php echo tr('ui_main.reporters');?></a>
				...
				?>
					<!-- green-box -->
					<div class="green-box">
						<h3><?php echo tr('ui_main.reporter_has_been');?> <?php echo $form_action; ?></h3>
					</div>
				<?php
				}
				?>
						...
						<div class="table-holder">
							<table class="table">
								<thead>
									<tr>
										<th class="col-1">&nbsp;</th>
										<th class="col-2"><?php echo tr('ui_main.reporter');?></th>
										<th class="col-3"><?php echo tr('ui_main.service');?></th>
	...
	'<?php echo(rawurlencode($reporter_date)); ?>')"><?php echo tr('ui_main.edit');?></a></li>
													<li><a href="javascript:orgAction('d','DELETE','<?php echo(rawurlencode($reporter_id)); ?>')" class="del"><?php echo tr('ui_main.delete');?></a></li>
												</ul>
											</td>
										</tr>
										<?php
