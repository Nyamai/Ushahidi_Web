...
<div class="bg">
	...
	<h3><?php echo tr('stats.visitor_summary');?></h3>
	
	<div id="time-period-selector">
		<p>
			<form method="get" action="<?php print url::base() ?>admin/stats/hits/" style="display: inline;">
				<?php echo tr('stats.choose_date_range');?>: <a href="<?php print url::base() ?>admin/stats/hits/?range=30"><?php echo tr('stats.time_range_1');?></a> <a href="<?php print url::base() ?>admin/stats/hits/?range=90"><?php echo tr('stats.time_range_2');?></a> <a href="<?php print url::base() ?>admin/stats/hits/?range=180"><?php echo tr('stats.time_range_3');?></a> <a href="<?php print url::base() ?>admin/stats/hits/"><?php echo tr('stats.time_range_all');?></a>
	...
	<div class="stats-wrapper clearfix">
		<div class="statistic first">
			<h4><?php echo tr('stats.unique_visitors');?></h4>
			<p><?php echo $uniques; ?></p>
		</div>
		<div class="statistic">
			<h4><?php echo tr('stats.visits');?></h4>
			<p><?php echo $visits; ?></p>
		</div>
		<div class="statistic">
			<h4><?php echo tr('stats.pageviews');?></h4>
	...
	<div class="two-col tc-left">
		<div class="tabs">
			<!-- tabset -->
			<ul class="tabset">
				<li><a <?php if($active_tab == 'uniques') echo 'class="active"'; ?> href="<?php print url::base() ?>admin/stats/hits/?range=<?php echo $range; ?>&dp1=<?php echo $dp1; ?>&dp2=<?php echo $dp2; ?>&active_tab=uniques"><?php echo tr('stats.unique_visitors');?></a></li>
				<li><a <?php if($active_tab == 'visits') echo 'class="active"'; ?> href="<?php print url::base() ?>admin/stats/hits/?range=<?php echo $range; ?>&dp1=<?php echo $dp1; ?>&dp2=<?php echo $dp2; ?>&active_tab=visits"><?php echo tr('stats.visits');?></a></li>
				<li><a <?php if($active_tab == 'pageviews') echo 'class="active"'; ?> href="<?php print url::base() ?>admin/stats/hits/?range=<?php echo $range; ?>&dp1=<?php echo $dp1; ?>&dp2=<?php echo $dp2; ?>&active_tab=pageviews"><?php echo tr('stats.pageviews');?></a></li>
			</ul>
	...
	<div class="two-col tc-right glossary">
		<h4><?php echo tr('stats.glossary');?></h4>
		<div class="terms">
			<p><strong><?php echo tr('stats.unique_visitors');?>:</strong> <?php echo tr('stats.unique_visitors_description');?>.</p>
			<p><strong><?php echo tr('stats.visits');?>:</strong> <?php echo tr('stats.visits_description');?>.</p>
			<p><strong><?php echo tr('stats.pageviews');?>:</strong> <?php echo tr('stats.pageviews_description');?>.</p>
		</div>
	</div>
