					...
					foreach ($laconica_mesgs as $laconica_mesg)
					{
						...
						<tr>
							...
							<td class="col-2">
								...
								<ul class="info">
									<li class="none-separator"><?php echo tr('ui_main.from');?>: <strong><a href="<?php echo $laconica_mesg_link; ?>" target="_blank"><?php echo $laconica_mesg_from; ?></a></strong>
								</ul>
							</td>
							...
							<td class="col-4">
								<ul>
									...
									{
										echo "<li class=\"none-separator\"><a href=\"". url::base() . 'admin/reports/edit?tid=' . $laconica_mesg_id ."\">".tr('ui_main.create_report')."?</a></li>";
									}
									?>
									<li>
                                    <!-- <a href="<?php echo url::base().'admin/messages/delete/'.$laconica_mesg_id ?>" onclick="return confirm(<?php echo tr('ui_main.action_confirm');?>)" class="del">Delete</a> --></li>
								</ul>
							</td>
						</tr>
						<?php
