...
?>
			<div class="bg">
				<h2>
					...
					<a href="<?php echo url::base() . 'admin/manage/layers' ?>" class="active"><?php echo tr('ui_main.layers');?></a>
				...
				?>
					<!-- green-box -->
					<div class="green-box">
						<h3><?php echo tr('ui_main.layer_has_been');?> <?php echo $form_action; ?>!</h3>
					</div>
				<?php
				}
				?>
						...
						<div class="table-holder">
							<table class="table">
								<thead>
									<tr>
										<th class="col-1">&nbsp;</th>
										<th class="col-2"><?php echo tr('ui_main.layer');?></th>
										<th class="col-3"><?php echo tr('ui_main.color');?></th>
										...
										<tr>
											...
											<td class="col-2">
												...
												<ul class="info">
													...
													if($layer_file)
													{
														?><li class="none-separator"><?php echo tr('ui_main.kml_kmz_file');?>: <strong><?php echo $layer_file; ?></strong>
												...
												<ul class="links">
													...
													if($layer_url)
													{
														?><li class="none-separator"><?php echo tr('ui_main.kml_url');?>: <strong><?php echo text::auto_link($layer_url); ?></strong></li><?php
													}
													?>
												</ul>
											</td>
											...
											<td class="col-4">
												<ul>
													<li class="none-separator"><a href="#add" onClick="fillFields('<?php echo(rawurlencode($layer_id)); ?>','<?php echo(rawurlencode($layer_name)); ?>','<?php echo(rawurlencode($layer_url)); ?>','<?php echo(rawurlencode($layer_color)); ?>','<?php echo(rawurlencode($layer_file)); ?>')"><?php echo tr('ui_main.edit');?></a></li>
													<li class="none-separator"><a href="javascript:layerAction('v','SHOW/HIDE','<?php echo(rawurlencode($layer_id)); ?>')"<?php if ($layer_visible) echo " class=\"status_yes\"" ?>><?php echo tr('ui_main.visible');?></a></li>
<li><a href="javascript:layerAction('d','DELETE','<?php echo(rawurlencode($layer_id)); ?>')" class="del"><?php echo tr('ui_main.delete');?></a></li>
												</ul>
											</td>
										</tr>
										<?php									
				...
				<div class="tabs">
					...
					<div class="tab">
						...
						<div class="tab_form_item">
							<strong><?php echo tr('ui_main.layer_name');?>:</strong><br />
							<?php print form::input('layer_name', '', ' class="text"'); ?>
						</div>
						<div class="tab_form_item">
							<strong><?php echo tr('ui_main.layer_url');?>:</strong><br />
						...
						<div class="tab_form_item">
							<strong><?php echo tr('ui_main.kml_kmz_upload');?>:</strong><br />
