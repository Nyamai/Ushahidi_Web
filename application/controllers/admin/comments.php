...
class Comments_Controller extends Admin_Controller
{
    ...
    */
	function index($page = 1)
	{
		...
		$this->template->content->title = tr('ui_admin.comments');
	    ...
	    if ($_POST)
	    {
			...
			if ($post->validate())
	        {
				...
				{ // Spam Action
					...
					$form_action = strtoupper(tr('ui_admin.marked_as_spam'));
				}
				...
				{ // Spam Action
					...
					$form_action = strtoupper(tr('ui_admin.marked_as_not_spam'));
				}
